...
<header>
	...
	<nav>
		...
		<ul>
			...
			<li aria-current={$page.url.pathname === '/question1' ? 'page' : undefined}>
				<a href="/question1">Question 1</a>
			</li>
			<li aria-current={$page.url.pathname === '/question2' ? 'page' : undefined}>
				<a href="/question2">Question 2</a>
			</li>
			<li aria-current={$page.url.pathname === '/question3' ? 'page' : undefined}>
				<a href="/question3">Question 3</a>
			</li>
			<li aria-current={$page.url.pathname === '/question4' ? 'page' : undefined}>
